...
class Raw_add_to_DB():
        ...
        def __init__(self, add_page):
            ...
            add_page.Add_button.place(x = 25, y = 330)
...
class Product_add_to_DB():
        ...
        def __init__(self, add_page):
            ...
            add_page.Date_of_Production_Enrty.config(width = 18,font = 15)
            add_page.Date_of_Production_Enrty.place(x = 300, y = 80)
            
            add_page.Name_of_Customer_Entry = Entry(add_page)
            add_page.Name_of_Customer_Entry.config(font = 15, width=20)
            ...
            add_page.Product_expiration_date_Enrty.config(width = 18,font = 15)
            ...
            add_page.list_of_raw_used_Entry.config(font = 15, width=20)
            ...
            add_page.Add_button = Button(add_page, text = "Add to Database", command= to_db)
            add_page.Add_button.place(x = 25, y = 380)
